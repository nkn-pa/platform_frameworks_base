...
public class UdfpsAnimation extends ImageView {
    ...
    public UdfpsAnimation(Context context, WindowManager windowManager,
        ...
        mUdfpsAnimationPackage = "org.derpfest.overlay.customization.udfps.animations";
        ...
        Uri udfpsAnim = Settings.Secure.getUriFor(Settings.Secure.UDFPS_ANIM);
            ...
            public void onChange(boolean selfChange, Uri uri) {
                if (udfpsAnim.equals(uri)) {
                    mEnabled = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                            Settings.Secure.UDFPS_ANIM, 0, UserHandle.USER_CURRENT) == 1;
