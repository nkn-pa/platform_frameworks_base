...
package com.android.systemui.derp.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.derp.header.STATUS_BAR_HEADER_UPDATE";
