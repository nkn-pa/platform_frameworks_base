...
package com.android.systemui.derpfest;
...
public class RebootSuggestion {
    ...
    private static final int REMIND_INTERVAL = 1; // days
    ...
    private final BroadcastReceiver rebootSuggestionReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (lastSuggestionTime != 0 &&
                (currentUpTime - lastSuggestionTime) > TimeUnit.DAYS.toMillis(REMIND_INTERVAL)) {
    ...
    public RebootSuggestion(Context context) {
        ...
        context.registerReceiver(rebootSuggestionReceiver, new IntentFilter(Intent.ACTION_DATE_CHANGED));
    }
