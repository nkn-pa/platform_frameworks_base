...
public class DisplayResolutionManager {
    ...
    private static final int DEVICE_TYPE =
            SystemProperties.getInt("ro.derpfest.display.resolution_switch", TYPE_DISABLED);

    public static final boolean RESTART_SYSTEMUI_ON_SWITCH =
            SystemProperties.getBoolean("persist.sys.derpfest.resolution.restart_sysui", false);
