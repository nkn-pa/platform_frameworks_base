...
import static org.derpfest.view.DisplayResolutionManager.QHD_WIDTH;
import static org.derpfest.view.DisplayResolutionManager.RESTART_SYSTEMUI_ON_SWITCH;
import static org.derpfest.view.DisplayResolutionManager.SCALE;
import static org.derpfest.view.DisplayResolutionManager.TYPE_AOSP_FHD_DEFAULT;
import static org.derpfest.view.DisplayResolutionManager.TYPE_DISABLED;
import static org.derpfest.view.DisplayResolutionManager.TYPE_FORCED;
...
public class DisplayResolutionController {
    ...
    private static final String PROP_SCALE_BOOTANIMATION =
            "persist.sys.derpfest.bootanimation.scale";
    ...
    public void initSystemExService(DerpFestSystemExService service) {
    ...
    public void systemReady() {
        ...
        if (overlayPkgList != null && overlayPkgList.length != 0) {
            for (String pkg : overlayPkgList) {
                if (derpUtils.isPackageInstalled(mContext, pkg)) {
    ...
    private void setResolutionInternal(int width, boolean onBoot) {
        ...
        applyOverlay(width == FHD_WIDTH);
        derpUtils.forceStopDefaultLauncher(mContext);
        if (RESTART_SYSTEMUI_ON_SWITCH) {
            derpUtils.restartSystemUi(mContext);
        }
