...
import com.android.internal.util.derpfest.FullscreenTaskStackChangeListener;
...
public class DerpFestSystemExService extends SystemService {

    private static final String TAG = "DerpFestSystemExService";
    ...
    public DerpFestSystemExService(Context context) {
        super(context);
    ...
    private void maybeCleanClonedUser(int userId) {
        ...
        if (!hasUserApp) {
            ...
            derpUtils.forceStopDefaultLauncher(getContext());
        }
    }
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            DerpFestSystemExService.this.onPackageRemoved(packageName);
        }
